    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndexCounters", x => x.Prefix);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityIndex = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ResidentialAddress_Street = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResidentialAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResidentialAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ThesisTopic = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offices_People_ProfessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePrerequisites", x => new { x.PrerequisitesId, x.RequiredById });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoursePrerequisites_Courses_RequiredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePrerequisites_RequiredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndexCounters_Prefix",
                table: "IndexCounters",
                column: "Prefix",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Offices_ProfessorId",
                table: "Offices",
                column: "ProfessorId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_People_UniversityIndex",
                table: "People",
                column: "UniversityIndex",
                unique: true);
        }
